"""
This code is adapted from (https://github.com/MorvanZhou/PyTorch-Tutorial)
...
class RNN(nn.Module):
    def __init__(self):
        ...
        self.rnn = GFLSTM(         # if use nn.RNN(), it hardly learns
            input_size=28,
            hidden_size=64,         # rnn hidden unit
    ...
    def forward(self, x):
        ...
        r_out, (h_n, h_c) = self.rnn(x, (zero_h.cuda(), zero_c.cuda()))   # None represents zero initial hidden state
